...
public class ElasticRepositoryVertxEBProxy implements ElasticRepository {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public ElasticRepositoryVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public ElasticRepositoryVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public  void findDocumentByQuery(String query, Handler<AsyncResult<JsonArray>> resultHandler){
    ...
    _deliveryOptions.addHeader("action", "findDocumentByQuery");
