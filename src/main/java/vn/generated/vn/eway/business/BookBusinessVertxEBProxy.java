...
public class BookBusinessVertxEBProxy implements BookBusiness {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public BookBusinessVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public BookBusinessVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public  void inrichmentField(JsonObject jsonObject, Handler<AsyncResult<JsonObject>> resultHandler){
    ...
    _deliveryOptions.addHeader("action", "inrichmentField");
